...
export const CloseBtn = () => {
	...
	return (
		<div className={`${modalOpts.login && 'absolute top-2 right-2'} ${modalOpts.register && 'absolute top-2 right-2'} lg:absolute lg:right-2 flex justify-center items-center w-12 h-12`}>

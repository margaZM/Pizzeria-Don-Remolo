...
export const Pizzas = () => {
	...
	return (
		<div id="pizzas" className="flex flex-col items-center w-full h-screen max-h-[380px] pt-2 gap-2 md:max-h-[400px] lg:max-h-[450px] scroll-mt-[195px] desktop_bk:scroll-mt-[242px]">
